...
def windows_exe(
    ...
    builder = WindowsBuilder(PROJECT_ROOT, verbose=verbose)
    builder.env.check_compliance(require_exe=True)
...
def windows_installer(
    ...
    builder = WindowsBuilder(PROJECT_ROOT, verbose=verbose)
    builder.env.check_compliance(require_installer=True)
...
def check(
    ...
    builder.env.check_compliance(require_exe=True, require_installer=True)
